...
type IPetService interface {
	...
	CtlGetPetByID(ctx context.Context, id int64) (pets models.Pet, err error)
	...
	ServiceGetPetsWhichExpiredCertificate(ctx context.Context) (pets []models.Pet, err error)
}
